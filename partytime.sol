...
# Official Timelock Contract of https://july.party/

# Firework Token Address:
#    0xaA1DeB0768D3ee41673bcA440941709DfB3486a6

# Holds 50% of total supply of Firework Token

# Token is released to 0x0dead address on July 4th, 2021 

# Decentralized burn performed through smart contract

# Call startTheParty function to initiate burn
...
# Code base derived from Open Zeppelin:
...
contract PartyTime {
     ...
     */
    function startTheParty() public virtual {
        // solhint-disable-next-line not-rely-on-time
        require(block.timestamp >= releaseTime(), "The party hasn't started yet");

        uint256 amount = token().balanceOf(address(this));
        require(amount > 0, "The party has already started");
